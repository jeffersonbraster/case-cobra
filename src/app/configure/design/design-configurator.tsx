...
import HandleComponent from "@/components/handle-components";
...
const DesignConfigurator = ({
  ...
  const {mutate: saveConfig} = useMutation({
    ...
    onError: () => {
      toast({
        title: "Erro ao salvar sua case",
        description: "Tivemos um problema ao salvar sua case. Tente novamente.",
        variant: "destructive",
      });
    },
    onSuccess: () => {
              ...
              <div className="flex flex-col gap-6">
                ...
                {[MATERIALS, FINISHES].map(
                  ({ name, options: selectableOptions }) => (
                    ...
                    >
                      <Label>
                        {name === "finish" ? "Acabamento" : "Material"}
                      </Label>
